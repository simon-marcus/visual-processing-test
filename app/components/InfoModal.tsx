        ...
        <div className="space-y-3 p-4 md:px-16 md:py-4">
          ...
          <div className="overflow-y-auto max-h-[60vh] px-0 py-2 space-y-2">
            <p className="text-sm md:text-base text-slate-700">
              ...
              <br /><br />
              By contrast, the ability to parse <i>visual</i> data in a three-dimensional space—say, retrieving a fallen object, packing a bag—is something that human toddlers can do with almost no guidance. Yet owing to the collossal quantum of data delivered through the visual cortex (the high bandwidth), even seemingly simple tasks like object recognition remain computationally expensive and conceptually challenging for artificial intelligence.
              <br /><br />
              This test helps to quantify the impressive speed and accuracy of the human central processing system:
              <br />
              <figure className="quote">
                <blockquote>
                  Despite the very high demands made on the visual system by such a task (the subjects had no apriori information about the type of animal to look for, its position or size, or even the number of animals present), performance was remarkably good. The average proportion of correct responses was 94%, with one of the fifteen subjects achieving 98% correct responses... This remarkable level of performance was possible despite the very brief presentations, which effectively rule out the use of eye movements during image processing [a...] each stimulus was only ever seen once, thus eliminating the possibility of stimulus-specific learning effects.
                </blockquote>
              </figure>
              This kind of test was significant to the field of artificial intelligence and machine learning, leading to advances in the field of computer vision through <a className="hover:text-sky-500 text-sky-800 transition-all delay-100" href="https://en.wikipedia.org/wiki/One-shot_learning_(computer_vision)">one shot</a> learning.
            
            <br /><br />
            <b>Thank you.</b> My code for this project can be found <a className="hover:text-sky-500 text-sky-800 transition-all delay-100" href="https://github.com/simon-marcus/visual-processing-test" target="_blank" rel="noopener">at GitHub</a>. If you have any questions or comments, please feel free to reach out via email <a className="hover:text-sky-500 text-sky-800 transition-all delay-100" href="mailto:simon@simonmarcus.org">simon@simonmarcus.org</a>.
            </p>
